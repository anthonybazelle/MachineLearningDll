...
AppWizard a créé cette DLL MLDll pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application MLDll.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé MLDll.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
